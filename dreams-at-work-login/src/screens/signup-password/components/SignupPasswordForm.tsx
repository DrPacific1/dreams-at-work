...
function SignupPasswordForm() {
  const [customerType, setCustomerType] = useState<"personal" | "business" | null>(null);
  ...
  const onSubmit = async (data: SignupPasswordOptions) => {
    ...
    await handleSignupPassword(submitData as SignupPasswordOptions);
  };
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        ...
        {/* Customer type toggle — mandatory */}
        ...
        <ULThemeButton
          type="submit"
          className="w-full"
          disabled={isSubmitting || !customerType}
        >
          {buttonText}
        </ULThemeButton>
      </form>
